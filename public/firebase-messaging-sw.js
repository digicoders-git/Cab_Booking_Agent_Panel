...
messaging.onBackgroundMessage((payload) => {
  ...
  const title = payload.notification?.title || payload.data?.title || "Agent Notification";
  const body = payload.notification?.body || payload.data?.body || "New update in your agent dashboard.";
  const icon = "/logo.png"; 
